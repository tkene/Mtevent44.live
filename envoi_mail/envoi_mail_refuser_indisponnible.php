...
$mail->Subject = "Produit indisponible";

$mail->msgHTML(file_get_contents('https://www.mtevent44.fr/envoi_mail/mail_refuser_indisponnible.php?prenom=' . $prenom . '&nom=' . $nom . '&nom_produit=' . $nom_produit));


$mail->AltBody = 'A bientôt';
...
if (!$mail->send()) {
    ...
    header("location:https://www.mtevent44.fr/admin/admin_tableau_bord_client.php?id_user1=" . $id_user . '&msg_refuser=true');
    ob_end_flush();
    exit();
}