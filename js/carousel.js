...
class Carousel {
    ...
    // Attribuer des classes CSS initiales aux éléments de galerie et de navigation
    setInitialState() {
    ...
    // Mettre à jour l'état de commande du carrousel avec les classes CSS
    ...
    // Construire la navigation du carrousel
    setNav() {
    ...
    // Construire les contrôles du carrousel
    setControls() {
        ...
        !!galleryControlsContainer.childNodes[0] ? galleryControlsContainer.childNodes[0].innerHTML = this
            .carouselControls[0] : null;
        !!galleryControlsContainer.childNodes[1] ? galleryControlsContainer.childNodes[1].innerHTML = this
            .carouselControls[1] : null;
    }


    // Ajouter un événements Click pour déclencher la méthode setCurrentState pour réorganiser le carrousel
    useControls() {
